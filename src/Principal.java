...
public class Principal {
    ...
    public static void main (String[] args){
        ...
        String n = "n";
        String g = "g";
        System.out.println("\n\nLa suma de los códigos de los caracteres de la palabra " + cadena + " es " + Metodos.sumaCodigos(cadena, 0, 0));
        System.out.println("\n\nLa suma de los códigos de los caracteres de la palabra " + S + " es " + Metodos.sumaCodigos(S,0,0));
    }
